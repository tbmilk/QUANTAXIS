...
/// 股票分钟线数据结构
pub struct QADataStruct_StockMin {
    pub data: DataFrame,
}

fn qa_schema_stock_min() -> Schema {
    use DataType::*;
    vec![
...
impl QADataStruct_StockMin {
    pub fn new_from_csv(path: &str) -> Self {
        let schema = qa_schema_stock_min();
    ...
    pub fn new_from_vec(
        ...
        let df = DataFrame::new(vec![
            ...
            Series::new("code".into(), code.clone()).into(),
            Series::new("order_book_id".into(), code).into(),
    ...
    pub fn save_cache(&mut self) {
        let cachepath = format!("{}stockmin.parquet", &CONFIG.DataPath.cache);
