...
> **最后更新**: 2026-05-18
> **验证状态**: ✅ **100%通过** (A+级，Python 3.9-3.14)
...
| 组件 | 旧版本 | 新版本 | 说明 |
|------|--------|--------|------|
| **Python** | 3.5-3.10 | **3.9-3.14** | ⚠️ 必须升级 |
| **pymongo** | 3.11.2 | 4.10.0+ | ⚠️ 需升级 |
| **pandas** | 1.1.5+ | 2.0.0+ | ⚠️ 需升级 |
| **pika** | 1.3.0 | 1.3.2+ | ⚠️ 需升级 |
| **pytdx** | 1.67 | 1.72 | ✅ 已修复 |
| **opentdx** | — | ≥0.1.2 (3.12+) | ✅ 新增数据后端 |
| **numpy** | — | ≥2.4.0 (3.14+) | ✅ 自动分流 |
| **pyarrow** | — | ≥24.0.0 (3.14+) | ✅ 自动分流 |
| **empyrical-reloaded** | — | ≥0.5.12 (3.14+) | ✅ 自动替换 |
